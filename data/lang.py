...
languages = {
    "en": {
        ...
        "login_error_official_only": f"This action requires an official compiled launcher. Please use the released executable, please visit <a style='color: #00aaff;' href='{variables.website_url}'>{variables.website_url}</a> to download it.",
        "login_error_no_system_access": "Launcher cannot write to its configuration directory. Please run the launcher with sufficient permissions.",
        "login_error_network": f"This build may not be official and may not have access to the service or its access has been revoked, please download the latest version from <a style='color: #00aaff;' href='{variables.website_url}'>{variables.website_url}</a>.",
        "cancel": "Cancel",
        ...
        "profiles": "Profiles",
        "profiles_manager": "Manage Profiles",
        "new_profile_name": "Profile Name",
        "create": "Create",
        "delete": "Delete",
        "ask_confirm": "Are you sure?",
        "profile_type_local": "Local",
        "profile_type_online": "Online",
        "profile_display_name": "Display name",
        "profile_type": "Type",
        "profile_delete_confirm": "Are you sure you want to delete this profile? This cannot be undone.",
        "cannot_delete_last_profile": "You cannot delete the last profile.",
        "profile_version": "Version",
        "quick_jvm": "Quick RAM (Xmx)",
        "quick_ram": "RAM (MB)",
        "custom_jvm": "Custom JVM args",
        "manual_jvm_placeholder": "Custom JVM args (-Xms512M -Xmx2048M ...)",
        "token_present": "Token: present",
        "token_missing": "Token: missing",
        "token_unknown": "Token: unknown",
        "test_token": "Test token",
        "revoke_token": "Revoke token",
        "token_missing_title": "No token",
        "token_test_ok": "Token OK",
        "token_test_ok_desc": "Refresh token seems valid",
        "token_test_failed": "Token failed",
        "token_test_failed_desc": "Refresh failed or token invalid",
    ...
    "es": {
        ...
        "login_error_official_only": f"Esta acción requiere un lanzador oficial compilado. Por favor, usa el ejecutable lanzado, visita <a style='color: #00aaff;' href='{variables.website_url}'>{variables.website_url}</a> para descargarlo.",
        "login_error_no_system_access": "El lanzador no puede escribir en su directorio de configuración. Ejecuta el lanzador con permisos suficientes.",
        "login_error_network": f"Es posible que este build no sea oficial y no tenga acceso al servicio o su acceso haya sido revocado, por favor descarga la última versión desde <a style='color: #00aaff;' href='{variables.website_url}'>{variables.website_url}</a>.",
        "cancel": "Cancelar",
        ...
        "profiles": "Perfiles",
        "profiles_manager": "Gestionar Perfiles",
        "new_profile_name": "Nombre de perfil",
        "create": "Crear",
        "delete": "Eliminar",
        "ask_confirm": "¿Estás seguro?",
        "profile_type_local": "Local",
        "profile_type_online": "En línea",
        "profile_display_name": "Nombre para mostrar",
        "profile_type": "Tipo",
        "profile_delete_confirm": "¿Estás seguro de que deseas eliminar este perfil? Esto no se puede deshacer.",
        "cannot_delete_last_profile": "No se puede eliminar el único perfil.",
        "profile_version": "Versión",
        "quick_jvm": "RAM rápida (Xmx)",
        "quick_ram": "RAM (MB)",
        "custom_jvm": "Argumentos JVM personalizados",
        "manual_jvm_placeholder": "Argumentos JVM personalizados (-Xms512M -Xmx2048M ...)",
        "token_present": "Token: presente",
        "token_missing": "Token: ausente",
        "token_unknown": "Token: desconocido",
        "test_token": "Probar token",
        "revoke_token": "Revocar token",
        "token_missing_title": "Sin token",
        "token_test_ok": "Token válido",
        "token_test_ok_desc": "El token de actualización parece válido",
        "token_test_failed": "Token inválido",
        "token_test_failed_desc": "La actualización falló o el token es inválido",
    ...
    "fr": {
        ...
        "login_error_official_only": f"Cette action nécessite un lanceur officiel compilé. Veuillez utiliser l'exécutable publié, veuillez visiter <a style='color: #00aaff;' href='{variables.website_url}'>{variables.website_url}</a> pour le télécharger.",
        "login_error_no_system_access": "Le lanceur ne peut pas écrire dans son répertoire de configuration. Exécutez le lanceur avec des autorisations suffisantes.",
        "login_error_network": f"Cette version peut ne pas être officielle et peut ne pas avoir accès au service ou son accès a été révoqué, veuillez télécharger la dernière version depuis <a style='color: #00aaff;' href='{variables.website_url}'>{variables.website_url}</a>.",
        "cancel": "Annuler",
        ...
        "microsoft_login_desc": "Inicia sesión con tu cuenta de Microsoft para acceder a Minecraft Java Edition.",
        "profiles": "Profils",
        "profiles_manager": "Gérer les profils",
        "new_profile_name": "Nouveau nom de profil",
        "create": "Créer",
        "delete": "Supprimer",
        "ask_confirm": "Êtes-vous sûr ?",
        "profile_type_local": "Local",
        "profile_type_online": "En ligne",
        "profile_display_name": "Nom affiché",
        "profile_type": "Type",
        "profile_delete_confirm": "Voulez-vous vraiment supprimer ce profil ? Cette action est irréversible.",
        "cannot_delete_last_profile": "Vous ne pouvez pas supprimer le dernier profil.",
        "profile_version": "Version",
        "quick_jvm": "RAM rapide (Xmx)",
        "quick_ram": "RAM (Mo)",
        "custom_jvm": "Arguments JVM personnalisés",
        "manual_jvm_placeholder": "Arguments JVM personnalisés (-Xms512M -Xmx2048M ...)",
        "token_present": "Jeton : présent",
        "token_missing": "Jeton : manquant",
        "token_unknown": "Jeton : inconnu",
        "test_token": "Tester le jeton",
        "revoke_token": "Révoquer le jeton",
        "token_missing_title": "Aucun jeton",
        "token_test_ok": "Jeton OK",
        "token_test_ok_desc": "Le jeton de rafraîchissement semble valide",
        "token_test_failed": "Échec du jeton",
        "token_test_failed_desc": "Le rafraîchissement a échoué ou le jeton est invalide",
